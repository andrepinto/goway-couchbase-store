...
func(l *LocalProductRepository) CreateProduct(product *Product_v1) ( bool, *Product_v1 ) {
	return false, nil
}

func(l *LocalProductRepository) CreateClient( client  *Client_v1 ) ( bool, *Client_v1 ) {
	return false, nil
}